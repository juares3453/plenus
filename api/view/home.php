...
<head>
    ...
    <style>
        ...
        #img-fundo-top {
            ...
            height: 1200px;
            background-image: url(api/fundo-top-home.png);
        ...
        #img-fundo-center {
            background-size: cover;
            height: 850px;
            background-image: url(api/fundo-center-home.png);
            background-repeat: no-repeat;
            background-position: center center;
            color: #fff;
        }
        ...
        .img-arrow-bottom {
            ...
            background-image: url(api/click-here.png);
...
<body>
	...
	<nav class="navbar fixed-top navbar-expand-sm navbar-dark bg-dark flex-sm-nowrap flex-wrap" id="navBar">
		<div class="container-fluid">
			...
			<button class="navbar-toggler flex-grow-sm-1 flex-grow-0 me-1" type="button" data-bs-toggle="collapse" data-bs-target="#navbar5">
			...
			<div class="flex-grow-1">
				<a class="navbar-brand">
					<img src="api/logo.png" height="55" alt="plenus logo"/>
				</a>
			</div>
			...
			<div class="navbar-collapse collapse flex-grow-2 justify-content-center" id="navbar5">
				<ul class="navbar-nav mx-auto">
					...
					<!-- <li class="nav-item" id="separacao">
						<a class="nav-link">|</a>
					</li> -->
					<li class="nav-item">
					...
					<!-- <li class="nav-item">
						<a class="nav-link" id="separacao">|</a>
					</li> -->
					<li class="nav-item">
				...
				<ul class="navbar-nav d-flex flex-row">
					<li class="nav-item me-2 me-lg-0">
						<a class="nav-link" href="#">
							<img src="api/icon_wpp.png" id="icon-social">
						</a>
					</li>
					<li class="nav-item me-2 me-lg-0">
						<a class="nav-link" href="#">
							<img src="api/icon_insta.png" id="icon-social">
						</a>
					</li>
					<li class="nav-item me-2 me-lg-0">
						<a class="nav-link" href="#">
							<img src="api/icon_face.png" id="icon-social">
						</a>
					</li>
				</ul>
            ...
            <div class="container-fluid" id="img-fundo-center">
                <div class="row" id="center-content">
                    ...
                    <div class="container-img-fundo-center">
                        <img src="api/fundo-1.png" alt="Image">
                    </div>
                </div>
            </div>
        </form>
	...
	<footer>
		<div class="container-footer">
			<img src="api/logo.png" alt="Logo da empresa">
